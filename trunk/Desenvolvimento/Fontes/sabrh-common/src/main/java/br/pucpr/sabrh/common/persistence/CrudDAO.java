...
/**
 * Interface representando as acoes basicas que podem ser executadas com objetos persistidos.
...
public interface CrudDAO<ENTITY, PK> {
     ...
     *             A exceção de persitência.
     */
    ENTITY querySingle(String namedQuery, Object... parametros) throws DAOException;
     ...
     *             A exceção de persitência.
     */
    List<ENTITY> queryList(String namedQuery, int numMax, int offset) throws DAOException;
     ...
     *             A exceção de persitência.
     */
    List<ENTITY> queryList(String namedQuery, Object... parametros) throws DAOException;
     ...
     *             A exceção de persitência.
     */
    List<ENTITY> queryList(String namedQuery, int numMax, int offset, Object... parametros)
        throws DAOException;
}
