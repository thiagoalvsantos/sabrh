...
--USUARIO
Insert into TB_USUARIO (CD_CODIGO,TX_CPF,TX_LOGIN,TX_NOME,IN_PERFIL,TX_SENHA,IN_STATUS,CD_MUNICIPIO) values (1,'12345678901','thiago','Thiago Alves','ADMINISTRADOR','admin','ATIVO',1);
